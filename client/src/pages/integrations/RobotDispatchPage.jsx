      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-slate-400">ROS 2 / SLAM Navigation</span>
          </div>
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-purple-500 hover:bg-purple-400 text-navy-950 font-bold text-xs shadow-glow-teal transition-all duration-200"
          >
              ...
              <GlassCard key={robot.robotId} className="p-5 border border-slate-800">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <h3 className="text-base font-bold text-white">{robot.name}</h3>
                    <p className="text-[11px] text-slate-400">{robot.model}</p>
                  </div>
                  <span
                ...
                <div className="mt-4 space-y-2 text-xs">
                  <div className="flex justify-between text-slate-300">
                    ...
                    <span className="font-semibold text-slate-200">{robot.floor}</span>
                  </div>
                  ...
                  <div className="flex justify-between text-slate-300">
                    ...
                    <span className="font-mono font-bold text-emerald-400">{robot.batteryLevel}%</span>
                  </div>
                  <ProgressBar value={robot.batteryLevel} color="emerald" height="h-1.5" />

                  <div className="pt-2 text-[10px] text-slate-400 border-t border-slate-800 flex items-center space-x-1">
                  ...
                  return (
                    <tr key={task._id} className="hover:bg-slate-800/30 transition-colors">
                      ...
                      <td className="py-3.5 px-4">
                        <div className="font-medium text-slate-200">{task.pickupLocation?.ward}</div>
                      ...
                      <td className="py-3.5 px-4 text-right">
                        {!isCompleted ? (
                          <button
                            ...
                            className="inline-flex items-center space-x-1 px-3 py-1.5 rounded-lg bg-teal-500/20 hover:bg-teal-500 text-teal-300 hover:text-navy-950 font-bold border border-teal-500/30 transition-all text-[11px]"
                          >
      ...
      >
        <form onSubmit={handleDispatchSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Robot Unit</label>
              <select
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Pickup Ward</label>
              <input
                type="text"
                required
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Destination Bay</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Payload (KG)</label>
              <input
                type="number"
                step="0.5"
                min="1"
