  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black tracking-tight text-slate-900">Biomedical Waste Logging</h1>
                  ...
                  <tr key={w._id} className="hover:bg-slate-50/30 transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <span className="text-slate-700 font-semibold">{w.category?.name}</span>
                      </div>
                    </td>
                    <td className="py-3 px-4 text-slate-600 font-medium">{w.department}</td>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              {bins.map((b) => (
                <option key={b._id} value={b._id} className="bg-surface-tertiary text-slate-900">
