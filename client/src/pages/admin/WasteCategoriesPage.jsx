  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black tracking-tight text-slate-900">Biomedical Waste Categories</h1>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <span className="font-mono font-bold text-xs uppercase px-2 py-0.5 rounded bg-slate-50 border border-slate-200 text-teal-600">
                      {cat.code}
                    </span>
                  </div>
                  <span
                ...
                <div className="p-3 rounded-xl bg-white/60 border border-slate-200/40 text-xs mb-3">
                  <div className="flex items-center space-x-1.5 text-teal-600 font-semibold mb-1">
                    <Package className="w-3.5 h-3.5" />
                    <span>Recommended Container</span>
                  </div>
                  <p className="text-slate-600 text-[11px]">{cat.recommendedContainer}</p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="w-9 h-9 rounded-lg bg-transparent cursor-pointer border border-slate-200"
                />
                <input
                  type="text"
                  value={formData.colorCode}
